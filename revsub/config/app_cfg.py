# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in revsub.
...
from revsub.lib import app_globals, helpers 

base_config = AppConfig()
base_config.renderers = []
base_config.prefer_toscawidgets2 = True

base_config.package = revsub
...
base_config.model = revsub.model
base_config.DBSession = revsub.model.DBSession
